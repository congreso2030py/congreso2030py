...
export default {
  ...
  methods: {
    ...
    pluralizeInitiatives: function(number_of_initiatives) {
      return (number_of_initiatives == 1) ? "expediente" : "expedientes";
    },
