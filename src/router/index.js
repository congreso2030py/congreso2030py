...
const routes = [{
    ...
    component: Search,
    meta: {
      title: 'Buscar - Congreso 2030 Paraguay',
      metaTags: [
        {
          name: 'description',
          content: 'Test Buscar'
  ...
  },
  {
    ...
    component: Search,
    meta: {
      title: 'Resultados - Congreso 2030 Paraguay',
      metaTags: [{
          name: 'description',
  ...
  },
  {
    ...
    meta: {
      title: 'Expediente - Congreso 2030 Paraguay',
      metaTags: [
        {
          name: 'description',
          content: 'Test Expediente'
        },
        {
          property: 'og:title',
          content: 'Expediente OG title'
        },
        {
          property: 'og:description',
          content: 'Test Expediente'
